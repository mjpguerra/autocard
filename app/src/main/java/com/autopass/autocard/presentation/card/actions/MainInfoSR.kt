...
class MainInfoSR(private val nfcController: NfcController) {
    ...
    fun save(
        ...
        return nfcController.card.writeInfoBlock(
            ...
            CardBlocks.MAIN_APP_INFO
        )
    }

    fun read(): InfoBlock = nfcController.card.readInfoBlock(CardBlocks.MAIN_APP_INFO)
}